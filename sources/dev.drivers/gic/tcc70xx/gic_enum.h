...
#define GIC_INT_TYPE_LEVEL_HIGH         (uint8)(0x1U)
#define GIC_INT_TYPE_LEVEL_LOW          (uint8)(0x2U)
#define GIC_INT_TYPE_EDGE_RISING        (uint8)(0x4U)
#define GIC_INT_TYPE_EDGE_FALLING       (uint8)(0x8U)
#define GIC_INT_TYPE_EDGE_BOTH          (uint8)(GIC_INT_TYPE_EDGE_RISING | GIC_INT_TYPE_EDGE_FALLING)

#define GIC_PRIORITY_NO_MEAN            (uint32)(16UL)

#define GIC_PPI_START                   (uint32)(16UL)
#define GIC_SPI_START                   (uint32)(32UL)

#define GIC_EINT_START_INT              (uint32)(GIC_EXT0)
#define GIC_EINT_END_INT                (uint32)(GIC_EXT9)
#define GIC_EINT_NUM                    ((uint32)GIC_EXTn0 - (uint32)GIC_EXT0)

#define GIC_INT_SRC_CNT                 ((uint32)GIC_SPU + 1UL)
